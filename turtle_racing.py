...
t5 = create_sprite("basketball",x5,y5)
...
if x1 >= x2 and x1 >= x3 and x1 >= x4 and x1 >= x5:
	...
	print("player 2 wins!")
elif x3 >= x2 and x3 >= x1 and x3 >= x4 and x3 >= x5:
	print("player 3 wins!")
elif x4 >= x2 and x4 >= x1 and x4 >= x3 and x3 >= x5:
	print("player 4 wins!")
elif x5 >= x2 and x5 >= x1 and x5 >= x4 and x5 >= x3:
	print("player 5 wins!")
